...
/**
 * Template Name: Donar User Profile backup
 *
...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] ) && $_POST['action'] == 'update-user' ) {
    ...
    wp_update_user( array( 'ID' => $current_user->ID, 'donar_weight', esc_attr( $_POST['donar_weight_input']) ) );
    if ( !empty( $_POST['donar_age_input'] ) )
    wp_update_user($current_user->ID, 'donar_age', esc_attr( $_POST['donar_age_input'] ) );
    if ( !empty( $_POST['donar_gender_input'] ) )
    wp_update_user( $current_user->ID, 'donar_gender', esc_attr( $_POST['donar_gender_input'] ) );
        
    if ( !empty( $_POST['donar_blood_group_input'] ) )
    wp_update_user( $current_user->ID, 'donar_blood_group', esc_attr( $_POST['donar_blood_group_input'] ) );
        
    if ( !empty( $_POST['donar_Presentdivision_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Presentdivision', esc_attr( $_POST['donar_Presentdivision_input'] ) );
        
    if ( !empty( $_POST['donar_Presentdistrict_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Presentdistrict', esc_attr( $_POST['donar_Presentdistrict_input'] ) );
        
    if ( !empty( $_POST['donar_Presentzilla_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Presentzilla', esc_attr( $_POST['donar_Presentzilla_input'] ) );
        
    if ( !empty( $_POST['donar_Presentupzilla_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Presentupzilla', esc_attr( $_POST['donar_Presentupzilla_input'] ) );
        
    if ( !empty( $_POST['donar_PresentFullAddress_input'] ) )
    wp_update_user( $current_user->ID, 'donar_PresentFullAddress', esc_attr( $_POST['donar_PresentFullAddress_input'] ) );
        
    if ( !empty( $_POST['donar_Permanentdivision_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Permanentdivision', esc_attr( $_POST['donar_Permanentdivision_input'] ) );
        
    if ( !empty( $_POST['donar_Permanentdistrict_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Permanentdistrict', esc_attr( $_POST['donar_Permanentdistrict_input'] ) );
        
    if ( !empty( $_POST['donar_Permanentzilla_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Permanentzilla', esc_attr( $_POST['donar_Permanentzilla_input'] ) );
        
    if ( !empty( $_POST['donar_Permanentupzilla_input'] ) )
    wp_update_user( $current_user->ID, 'donar_Permanentupzilla', esc_attr( $_POST['donar_Permanentupzilla_input'] ) );
        
    if ( !empty( $_POST['donar_PermanentFullAddress_input'] ) )
    wp_update_user( $current_user->ID, 'donar_PermanentFullAddress', esc_attr( $_POST['donar_PermanentFullAddress_input'] ) );
        ...
        <div class="entry-content entry">
            ...
            <?php else : ?>
                ...
                <form method="post" id="adduser" action="<?php the_permalink(); ?>">
                    ...
                    <p class="form-extra">
                        <label for="donar_weight_input"><?php _e('Donor Weight', 'profile'); ?></label>
                        <input class="text-input" name="donar_weight_input" type="text" id="donar_weight_input" value="<?php the_author_meta( 'donar_weight', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_age_input"><?php _e('Donar Age', 'profile'); ?></label>
                        <input class="text-input" name="donar_age_input" type="text" id="donar_age_input" value="<?php the_author_meta( 'donar_age', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_gender_input"><?php _e('Donar Gender', 'profile'); ?></label>
                        <input class="text-input" name="donar_gender_input" type="text" id="donar_gender_input" value="<?php the_author_meta( 'donar_gender', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_blood_group_input"><?php _e('Donar Blood Group', 'profile'); ?></label>
                        <input class="text-input" name="donar_blood_group_input" type="text" id="donar_blood_group_input" value="<?php the_author_meta( 'donar_blood_group', $current_user->ID ); ?>" />
                    </p>

                    <h3>Present Address</h3> -->

                    <p class="form-extra">
                        <label for="donar_Presentdivision_input"><?php _e('Division', 'profile'); ?></label>
                        <input class="text-input" name="donar_Presentdivision_input" type="text" id="donar_Presentdivision_input" value="<?php the_author_meta( 'donar_Presentdivision', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_Presentdistrict_input"><?php _e('District', 'profile'); ?></label>
                        <input class="text-input" name="donar_Presentdistrict_input" type="text" id="donar_Presentdistrict_input" value="<?php the_author_meta( 'donar_Presentdistrict', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_Presentzilla_zilla_input"><?php _e('Zilla', 'profile'); ?></label>
                        <input class="text-input" name="donar_Presentzilla_zilla_input" type="text" id="donar_Presentzilla_zilla_input" value="<?php the_author_meta( 'donar_Presentzilla', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_Presentupzilla_input"><?php _e('Upzilla', 'profile'); ?></label>
                        <input class="text-input" name="donar_Presentupzilla_input" type="text" id="donar_Presentupzilla_input" value="<?php the_author_meta( 'donar_Presentupzilla', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_PresentFullAddress_input"><?php _e('Present Full Address', 'profile'); ?></label>
                        <input class="text-input" name="donar_PresentFullAddress_input" type="text" id="donar_PresentFullAddress_input" value="<?php the_author_meta( 'donar_PresentFullAddress', $current_user->ID ); ?>" />
                    </p>

                    <h3>Permanent Address</h3>

                    <p class="form-extra">
                        <label for="donar_Permanentdivision_input"><?php _e('Division', 'profile'); ?></label>
                        <input class="text-input" name="donar_Permanentdivision_input" type="text" id="donar_Permanentdivision_input" value="<?php the_author_meta( 'donar_Permanentdivision', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_Permanentdistrict_input"><?php _e('District', 'profile'); ?></label>
                        <input class="text-input" name="donar_Permanentdistrict_input" type="text" id="donar_Permanentdistrict_input" value="<?php the_author_meta( 'donar_Permanentdistrict', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_Permanentzilla_input"><?php _e('Zilla', 'profile'); ?></label>
                        <input class="text-input" name="donar_Permanentzilla_input" type="text" id="donar_Permanentzilla_input" value="<?php the_author_meta( 'donar_Permanentzilla', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_Permanentupzilla_input"><?php _e('Upzilla', 'profile'); ?></label>
                        <input class="text-input" name="donar_Permanentupzilla_input" type="text" id="donar_Permanentupzilla_input" value="<?php the_author_meta( 'donar_Permanentupzilla', $current_user->ID ); ?>" />
                    </p>

                    <p class="form-extra">
                        <label for="donar_PermanentFullAddress_input"><?php _e('Permanent Full Adress', 'profile'); ?></label>
                        <input class="text-input" name="donar_PermanentFullAddress_input" type="text" id="donar_PermanentFullAddress_input" value="<?php the_author_meta( 'donar_PermanentFullAddress', $current_user->ID ); ?>" />
                    </p>
                                    ...
                                    <div class="applyForDonar">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a href="<?php echo home_url().'/donor-apply'?>"><button>Apply</button></a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="donationStatusBody">
                                            <div class="donationAfter">
                                                <div class="donationStatus">
                                                    <h1><i class="fas fa-traffic-light"></i> BLOOD DONATION STATUS <span>YOU CAN</span></h1>
                                                </div>
...
<input style="width: 50%;" type="text" name="donar_Presentdistrict" id="donar_Presentdistrict" value="</?php echo esc_attr( get_the_author_meta( 'donar_Presentdistrict', $user->ID ) ); ?>" placeholder="Your District eg: Bougra"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span>


                    <input style="width: 50%;" type="text" name="donar_Presentzilla" id="donar_Presentzilla" value="</?php echo esc_attr( get_the_author_meta( 'donar_Presentzilla', $user->ID ) ); ?>" placeholder="Your Zilla eg: Admdighi"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span>



                    <!-- <input style="width: 50%;" type="text" name="donar_Presentdivision" id="donar_Presentdivision" value="<?php echo esc_attr( get_the_author_meta( 'donar_Presentdivision', $user->ID ) ); ?>" placeholder="Your Division eg: Rajsahi"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span> -->


                    <!-- <select name="bloodDonarDistrictper" id="bloodDonarDistrictper">
                    ...
                    <!-- <select name="bloodDonarUpzillaper" id="bloodDonarUpzillaper">
                        <option </?php echo esc_attr( get_the_author_meta( 'donar_Presentzilla', $user->ID ) ); ?>><?php echo esc_attr( get_the_author_meta( 'donar_Presentzilla', $user->ID ) ); ?></option>
                        <option value="#">select District</option>
                    </select> -->
                    ...
                    <!-- <input style="width: 50%;" type="text" name="donar_Permanentdivision" id="donar_Permanentdivision" value="<?php echo esc_attr( get_the_author_meta( 'donar_Permanentdivision', $user->ID ) ); ?>" placeholder="Your Division eg: Rajsahi"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span> -->


                    <!-- <input style="width: 50%;" type="text" name="donar_Permanentdistrict" id="donar_Permanentdistrict" value="<?php echo esc_attr( get_the_author_meta( 'donar_Permanentdistrict', $user->ID ) ); ?>" placeholder="Your District eg: Bougra"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span> -->


                    
                    <!-- <input style="width: 50%;" type="text" name="donar_Permanentzilla" id="donar_Permanentzilla" value="<?php echo esc_attr( get_the_author_meta( 'donar_Permanentzilla', $user->ID ) ); ?>" placeholder="Your Zilla eg: Admdighi"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span> -->

                    <!-- <tr>
                <th><label for="donar_Permanentupzilla"><?php _e("Upzilla"); ?></label></th>
                <td>
                    <input style="width: 50%;" type="text" name="donar_Permanentupzilla" id="donar_Permanentupzilla" value="<?php echo esc_attr( get_the_author_meta( 'donar_Permanentupzilla', $user->ID ) ); ?>" placeholder="Your Upzilla eg: Santahar"/><br/>
                    <span class="description"><?php _e("example : 10KG"); ?></span>
                </td>
            </tr> -->
...
<div class="col-md-3">
                                                                <input type='text' name='donarPermanentupzilla' id='donarPermanentupzilla' value="<?php the_author_meta( 'donar_Permanentupzilla', $current_user->ID ); ?>" readonly/>
                                                            </div>

                                                            
                                                            <div class="col-md-3">
                                                                <input type='text' name='donarPresentupzilla' id='donarPresentupzilla' value="<?php the_author_meta( 'donar_Presentupzilla', $current_user->ID ); ?>" readonly/>
                                                            </div>
                        ...
                        <p><?php the_title() ?></p>
                        <p><?php $custom_post_type_1 = get_post_meta($post->ID, 'Donar_bloodGroup_register', true); echo $custom_post_type_1; ?></p>
                        <p><?php $custom_post_type_2 = get_post_meta($post->ID, 'Donar_presentdistrict_register', true); echo $custom_post_type_2; ?></p>
                        <p><?php $custom_post_type_3 = get_post_meta($post->ID, 'Donar_presentdivision_register', true); echo $custom_post_type_3; ?></p>
                    </div>
                    <!-- flat-item -->
...
//     $location = home_url().'/donor-dashboard'; 

//     echo "<meta http-equiv='refresh' content='0;url=$location' />";
//     exit;

// }
<?php echo home_url().'/'.$bangladeshbdooption['donar_Profile_update'] ?>

//
        // function DonarpermanentUpZilla(){
        //     add_meta_box("custom_bdo_field_103", "Donar permanent UpZilla", "DonarpermanentUpZillafun", "bangladesh_bdo_donar", "normal", "low");
        // }
        // add_action("admin_init", "DonarpermanentUpZilla");

        // function DonarpermanentUpZillafun(){

        //     global $post;

        //     $data = get_post_custom($post->ID);
        //     $val = isset($data['Donar_permanentupzilla_register']) ? esc_attr($data['Donar_permanentupzilla_register'][0]) : '';

        //     echo '<input type="text" name="Donar_permanentupzilla_register" id="Donar_permanentupzilla_register" value="'.$val.'" placeholder="permanent Upzilla" readonly/>';
        // }

        // function save_Donar_permanentupzilla_register(){
        //     global $post;

        //     if(isset($_POST["Donar_permanentdistrict_register"])):
         
        //         update_post_meta($post->ID, "Donar_permanentupzilla_register", $_POST["Donar_permanentupzilla_register"]);
             
        //     endif;

        // }
        // add_action("save_post", "save_Donar_permanentupzilla_register");
    //


    //
        // function DonarPresentUpZilla(){
        //     add_meta_box("custom_bdo_field_80", "Donar Present UpZilla", "DonarPresentUpZillafun", "bangladesh_bdo_donar", "normal", "low");
        // }
        // add_action("admin_init", "DonarPresentUpZilla");

        // function DonarPresentUpZillafun(){

        //     global $post;

        //     $data = get_post_custom($post->ID);
        //     $val = isset($data['Donar_presentupzilla_register']) ? esc_attr($data['Donar_presentupzilla_register'][0]) : '';

        //     echo '<input type="text" name="Donar_presentupzilla_register" id="Donar_presentupzilla_register" value="'.$val.'" placeholder="Present Upzilla" readonly/>';
        // }

        // function save_Donar_presentupzilla_register(){
        //     global $post;

        //     if(isset($_POST["Donar_presentupzilla_register"])):
         
        //         update_post_meta($post->ID, "Donar_presentupzilla_register", $_POST["Donar_presentupzilla_register"]);
             
        //     endif;

        // }
        // add_action("save_post", "save_Donar_presentupzilla_register");
    //
